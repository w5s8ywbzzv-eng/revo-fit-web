...
const logDict = {
  ...
  id: { ttl: "Catatan", sleep: "Tidur", sleepHours: "Jam", sleepQuality: "Kualitas", food: "Makanan", meal: "Apa yang kamu makan", mealType: "Jenis makanan", breakfast: "Sarapan", lunch: "Makan siang", dinner: "Makan malam", snack: "Camilan", calories: "Kalori", move: "Gerakan", duration: "Menit", bodyParts: "Bagian tubuh", weight: "Berat", kg: "kg", bowel: "Buang air besar", mood: "Suasana hati", submit: "Kirim", success: "Disimpan", error: "Kesalahan" },
};
